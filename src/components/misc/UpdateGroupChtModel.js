...
import { Box, Button, chakra, FormControl, IconButton, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Spinner, useDisclosure, useToast } from '@chakra-ui/react'
...
const UpdateGroupChtModel = ({fetchAgain,setFetchAgain,fetchMessages}) => {
    ...
    const handleRemove = async(user1) => {
        ...
        try {
            ...
            toast({
                ...
                description:error.response.data.messaage,
                status:"error",
                duration:5000,
                isClosable:true,
                position:"bottom",
      ...
      <>
        ...
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
          ...
          <ModalContent>
            ...
            <ModalCloseButton />
            <ModalBody>
                <Box w="100%" display="flex" flexDir="wrap" pb={3}>
...
export default UpdateGroupChtModel
